...
/**
 * The Class JasperFileProvider.
 *
 * @author The eFaps Team
 */
public class JasperFileProvider
{
    /**
     * Jasper Files.
     *
     ...
     */
    @DataProvider(name = "JasperFiles")
    public static Iterator<Object[]> jasperFiles(final ITestContext _context)
    {
        ...
        final Collection<File> files = FileUtils.listFiles(new File(baseFolder), new String[] { "jrxml" }, true);
