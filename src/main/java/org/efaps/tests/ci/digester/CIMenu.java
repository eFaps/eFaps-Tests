    ...
    extends AbstractCI
{
     ...
     */
    private final List<CIMenuDefinition> definitions = new ArrayList<>();
     ...
     */
    @SetNext
    public void addDefinition(final CIMenuDefinition _definition)
    {
     ...
     */
    public List<CIMenuDefinition> getDefinitions()
    {
