    ...
    extends AbstractCI
{
    ...
    @BeanPropertySetter(pattern = "ui-command/file-application")
    private String application;

    /**
     * The definitions belonging to this command.
     */
    private final List<CICommandDefinition> definitions = new ArrayList<>();
     ...
     */
    @SetNext
    public void addDefinition(final CICommandDefinition _definition)
    {
     ...
     */
    public List<CICommandDefinition> getDefinitions()
    {
