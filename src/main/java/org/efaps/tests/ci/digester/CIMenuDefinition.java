...
@ObjectCreate(pattern = "ui-menu/definition")
public class CIMenuDefinition

{

    @BeanPropertySetter(pattern = "ui-menu/definition/name")
    private String name;

    @BeanPropertySetter(pattern = "ui-menu/definition/target/form")
    private String targetForm;

    @BeanPropertySetter(pattern = "ui-menu/definition/target/table")
    private String targetTable;

    private final List<CIMenuProperty> properties = new ArrayList<>();


    @SetNext
    public void addProperty(final CIMenuProperty _property)
    {
     ...
     */
    public List<CIMenuProperty> getProperties()
    {
