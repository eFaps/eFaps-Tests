    ...
    extends AbstractCI
{
    ...
    @BeanPropertySetter(pattern = "ui-table/file-application")
    private String application;


    /**
     * The definitions belonging to this Table.
     */
    private final List<CITableDefinition> definitions = new ArrayList<>();
     ...
     */
    @SetNext
    public void addDefinition(final CITableDefinition _definition)
    {
     ...
     */
    public List<CITableDefinition> getDefinitions()
    {
