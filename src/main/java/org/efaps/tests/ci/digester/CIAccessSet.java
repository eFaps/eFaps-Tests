 ...
 */
@ObjectCreate(pattern = "access-set")
public class CIAccessSet
    extends AbstractCI
{
    /**
     * The uuid of this command.
     */
    @BeanPropertySetter(pattern = "access-set/uuid")
    private String uuid;

    /** The file application. */
    @BeanPropertySetter(pattern = "access-set/file-application")
